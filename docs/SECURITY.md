# Cogni-OS 2.0 v0.3.0 Security and Safety Model

## Release boundary

Version 0.3.0 is a local research runtime with a **proposal-only** evolution
...
## Deliberately unavailable in v0.3.0
...
offline environment before launch. Do not allow runtime downloads. The v0.3.0
