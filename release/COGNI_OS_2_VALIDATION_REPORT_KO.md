...
기준일: 2026-07-10  
소스 버전: `0.1.0`  
구현 규모: Python 67개 파일, 14,478줄, 테스트 파일 31개
...
결과: `179 tests passed, 32 subtests passed`.
...
- 감사 이벤트: **8개 전 단계 누적**, 각 이벤트의 로컬 표시 시각·ISO 원시 시각 보존
- 1366×768 발표 화면: 가로 overflow 없음, hero·4개 KPI·P-S-S-D story 동시 노출
- IR 가이드: **6/6 단계**, 마지막 CTA에서 실제 검증으로 직접 연결
...
- 소스 archive: `Cogni-OS-2-Genesis-source.zip`
  - SHA-256: `6ed8694e8df510aff3b9a19e535b34dd84f271f7e56fe142bec51f53354648b3`
- wheel: `cogni_os-0.1.0-py3-none-any.whl`
  - SHA-256: `56f9ea7e810c525c53f82fb85c3c0842d74ec24cd02b3f213cfa108b81d14a30`
